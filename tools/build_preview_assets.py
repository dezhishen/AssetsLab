...
def main() -> int:
    ...
    manifest = {
        ...
        "skeleton_walk_pipeline": {
            "source": "prototype/assets/characters/generated/skeleton_walk_pipeline_v1/side_arm_swing_manifest.json",
            "stage": "side_opposite_arm_swing",
            "status": "active_review",
            "next_stage": "back_skeleton",
        },
