...
def main() -> int:
    ...
    manifest = {
        ...
        "notes": "Review candidate generated from the recommended base. The fourth/fifth frame transition uses the opposite leg in front; this is not the older redraw adapter.",
    }
